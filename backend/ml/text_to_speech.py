...
# VOICE_OPTIONS = {
#     "Monika": "Lhkfd0eq2F87bgx4Aozc",   # Calm & professional
#     "Devajit": "gkYRuS6pUw0UJKhibzSx",  # Friendly 
#     "Shaurya": "lyPbHf3pO5t4kYZYenaY",  # Confident male
#     "Sia": "6JsmTroalVewG1gA6Jmw",      # Warm & empathetic
# }
...
VOICE_OPTIONS = {
    "Monika": "wlmwDR77ptH6bKHZui0l",   # Calm & professional
    "Devajit": "gkYRuS6pUw0UJKhibzSx",  # Friendly
    "Shaurya": "lyPbHf3pO5t4kYZYenaY",  # Confident male
    "Sia": "6JsmTroalVewG1gA6Jmw",      # Warm & empathetic
}

CURRENT_VOICE = "Sia"  # default
...
def speak_text(text: str, play_local: bool = False):
    ...
    ✅ DISABLED: ElevenLabs (commented out - using only D-ID avatar voice)
    ✅ Fallback to pyttsx3 (for local testing only)
    ✅ Upload to Supabase + return both Base64 + public URL
    """
    audio_base64, audio_url = None, None

    # ❌ ELEVENLABS DISABLED - Using D-ID avatar voice instead
    # try:
    #     if USE_ELEVEN:
    ...
    # 🧠 Local fallback TTS (for testing/debugging only - D-ID provides the actual voice)
