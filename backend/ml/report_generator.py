...
def compile_scores(evaluation_results: dict, metadata: Optional[dict] = None) -> Dict[str, dict]:
    ...
    technical_feedback = generate_technical_feedback(
        evaluation_results.get("technical", 0),
        evaluation_results.get("per_question", [])
    )
    ...
    report = {
        ...
        "feedback": {
            ...
            "communication": "Continue improving structure and clarity in responses.",
            "confidence": "Maintain eye contact and steady tone during answers.",
            "professionalism": "Good etiquette. Stay consistent across all interviews."
        },
